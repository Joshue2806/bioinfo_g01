...
echo "Número de filas:" `wc -l < n8.txt`   #En este contamos el número de filas o líneas con wc -l y < es para que no se vuelva a imprimir el nombre del archivo
...
#Si se desea correr este código, realizarlo en Git Bash con el comando "bash netsize.sh"
